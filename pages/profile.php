                  ...
                  <div class="card profile-card-2">
                    ...
                    <div class="card-body pt-5">
                      ...
                      <div class="icon-block">
                        <a href="javascript:void();"><i class="fa-brands fa-facebook-f text-white"></i></a>
                        <a href="javascript:void();"><i class="fa-brands fa-twitter text-white"></i></a>
                        <a href="javascript:void();"><i class="fa-brands fa-google text-white"></i></a>
                      </div>
                    </div>
                ...
                <div class="col-lg-8">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                      <li class="nav-item">
                          <a href="javascript:void();" data-target="#profile" data-toggle="pill" class="nav-link active"><i class="fa fa-user"></i> <span class="hidden-xs">Profile</span></a>
                      </li>
                      <li class="nav-item">
                          <a href="javascript:void();" data-target="#messages" data-toggle="pill" class="nav-link"><i class="fa-solid fa-envelope-open"></i> <span class="hidden-xs">Messages</span></a>
                      </li>
                      <li class="nav-item">
                          <a href="javascript:void();" data-target="#edit" data-toggle="pill" class="nav-link"><i class="fa-solid fa-note-sticky"></i> <span class="hidden-xs">Edit</span></a>
                      </li>
                    </ul>
