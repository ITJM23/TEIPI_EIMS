              ...
              <div class="card-title text-uppercase text-center py-3">Sign Up</div>
                ...
                <div class="form-row mt-4">
                  <div class="form-group mb-0 col-6">
                    <button type="button" class="btn btn-light btn-block"><i class="fa-brands fa-facebook-square"></i> Facebook</button>
                  </div>

                  <div class="form-group mb-0 col-6 text-right">
                    <button type="button" class="btn btn-light btn-block"><i class="fa-brands fa-twitter-square"></i> Twitter</button>
                  </div>
			          </div>
